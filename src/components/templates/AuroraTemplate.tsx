            ...
            {mounted && (
                ...
                <footer id="contact" className="py-40 px-6 text-center">
                    ...
                    >
                        ...
                        <div className="flex justify-center gap-8 mt-24 mb-32">
                            {data.contact.githubUrl && (
                                <a href={data.contact.githubUrl} className="text-3xl text-amber-900/40 hover:text-amber-900 transition-all hover:scale-125">
                                    <FaGithub />
                                </a>
                            )}
                        ...
                        <div className="text-[10px] font-black text-amber-900/30 tracking-[0.5em] uppercase">
                            © 2026 // {data.contact.location || 'GLOBAL_REMOTE'}
                        </div>
                    </motion.div>
                </footer>
            </div>
