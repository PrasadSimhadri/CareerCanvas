...
const templates = [
  ...
  },
  {
    ...
    tagline: 'Warm & Interactive',
    description: 'A premium "Sunbeam" theme with a light yellow/amber palette. Features magnetic interactivity where elements subtly react to your movements.',
    why: [
      'Warm amber and sunbeam-light yellow palette',
      'Interactive magnetic hero and buttons',
      'Floating glowing particles and ambient light',
      'Premium glassmorphism navigation bar',
      'Sophisticated and welcoming professional identity',
    ],
    preview: {
      bg: 'bg-[#fffdf0]',
      accent: '#f59e0b',
  ...
  },
  {
    ...
    tagline: 'Deep Cyber & Interactive',
    description: 'A high-contrast dark theme with sharp neon accents and interactive expanding project cards. Built for the modern, high-performance developer.',
    why: [
      'Deep dark blue and slate professional aesthetic',
      'Interactive expanding project detail cards',
      'Progressive scroll-reveals for all sections',
      'Electric cyan and neon purple highlight accents',
      'High-energy, technical developer presence',
    ],
    preview: {
      bg: 'bg-[#0a0f1e]',
      accent: '#00f2ff',
